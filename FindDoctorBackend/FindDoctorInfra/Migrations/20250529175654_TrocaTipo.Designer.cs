...
namespace FindDoctorInfra.Migrations
{
    ...
    [Migration("20250529175654_TrocaTipo")]
    partial class TrocaTipo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FindDoctorDomain.Entities.Cidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FindDoctorDomain.Entities.Convenio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FindDoctorDomain.Entities.EstabelecimentoConvenio", b =>
                {
                    b.Property<string>("CodigoCNES")
                        .HasColumnType("text");
                    ...
                    b.HasKey("CodigoCNES", "ConvenioId");

                    b.HasIndex("ConvenioId");

                    b.ToTable("EstabelecimentosConvenios");
                });

            modelBuilder.Entity("FindDoctorDomain.Entities.Estado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FindDoctorDomain.ValueObjects.EstabelecimentoComProfissional", b =>
                {
                    b.Property<string>("Bairro")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("EstabelecimentoComProfissional");
                });
            ...
            modelBuilder.Entity("FindDoctorDomain.Entities.EstabelecimentoConvenio", b =>
                {
                    ...
                    b.HasOne("FindDoctorDomain.Entities.Convenio", "Convenio")
                        .WithMany("Convenios")
